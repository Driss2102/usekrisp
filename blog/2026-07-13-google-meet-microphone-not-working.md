...
A working mic is step one. If your audio is noisy once it is back, that is a separate fix. See our [guide on Krisp for Google Meet](/docs/use/google-meet) for clean audio on top of a working mic.
